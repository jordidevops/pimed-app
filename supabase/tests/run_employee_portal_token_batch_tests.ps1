...
$test = "employee_portal_token_batch_tests.sql"
...
if ($LASTEXITCODE -ne 0 -or $hasSqlErrorText) {
  throw "employee_portal_token_batch_tests failed."
}

Write-Host "employee_portal_token_batch_tests passed." -ForegroundColor Green
