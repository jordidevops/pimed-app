...
$test = "employee_portal_identity_gate_tests.sql"
...
if ($LASTEXITCODE -ne 0 -or $hasSqlErrorText) {
  throw "employee_portal_identity_gate_tests failed."
}

Write-Host "employee_portal_identity_gate_tests passed." -ForegroundColor Green
