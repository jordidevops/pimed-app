-- Track C3.4 — D2 export: compensation balance column
...
COMMENT ON FUNCTION api.export_payroll_period(uuid, date, date, uuid, text) IS
  'Export nòmina ampliat (dies, absències, IT, overtime, buckets G4, saldo compensació C3). Lectura: no marca exported.';
