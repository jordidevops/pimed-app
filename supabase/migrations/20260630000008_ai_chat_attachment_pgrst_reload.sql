-- Refresca PostgREST després de get_ai_chat_attachment_file_service (M2 fix)
-- Evita PGRST202 "Could not find the function ... in the schema cache"
...
BEGIN
  ...
  IF p_file_id IS NULL THEN
    RAISE EXCEPTION 'p_file_id is required';
  END IF;
