-- create_signing_session: gen_random_bytes viu a schema extensions (pgcrypto).
-- SET search_path = data, public no el resol — mateix patró que create_document_share_link.
