  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl p-8">
      ...
      <button
        ...
        disabled={loading}
        className="w-full flex items-center justify-center gap-3 border border-gray-300 hover:bg-gray-50 disabled:opacity-50 text-gray-700 font-semibold py-2.5 rounded-lg transition"
      >
        <GoogleIcon />
