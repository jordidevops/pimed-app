...
/**
 * Custom domain root → redirigeix a /_sites/{domain}/{default_locale}
 * que serà reescrit pel proxy a /_sites/{domain}/{locale}/home
 */
export default async function CustomDomainRootPage({ params }: Props) {
  ...
  // El middleware ja va reescriure /_sites/{domain}, ara naveguem al locale
  redirect(`/${locale}`)
}
