...
> **Fase activa:** **QT-8** (no obert). QT-7 tancat 2026-09-17. No obrir QT-8 a la mateixa sessió.
...
| 9 | **QT-9** Pipeline de firma nativa | ❌ | Depèn de QT-2, QT-8 **i de la Fase 4 (pendent, no només proposada) del pla de signatures** |
| 10 | **QT-10** Submission Hub | ❌ | Depèn de QT-9; la part de backend/Centre d'aquell pla (Fase 1+3) ja està feta, no bloqueja |
