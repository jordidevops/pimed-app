...
| [`05-contract-signing-forward-compat.md`](./05-contract-signing-forward-compat.md) | Disseny únicament: com encaixarà el futur contracte signat post-acceptació |
| [`06-phases-and-backlog.md`](./06-phases-and-backlog.md) | Epics QT-0…QT-7, dependències, gates, fora d'abast |
...
- Motor de plantilles nou: es reutilitza el ja existent (`document_templates`, LiquidJS, Docxtemplater, Gotenberg).
